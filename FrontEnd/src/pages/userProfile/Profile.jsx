          ...
          <div className="p-2 mt-5 w-30">
            <div className="p-2 m-5">
              <div className="profile-pic">
                ...
                {props.userProfile.profile.profileImage ? (
                  <img
                    alt="profileImage"
                    src={props.userProfile.profile.profileImage}
                    id="output"
                    width="200"
                  />
                ) : (
            ...
            <div className="p-2 mt-5">
              <button
                ...
                disabled={
                  !props.userProfile.profile.profileImage ? true : false
                }
              >
                Delete Image
              </button>
              ...
              <div className="mt-5 d-flex">
                <div className="w-50">
                  ...
                  <h5 className="card-title">
                    {props.userProfile.profile.firstName}
                  </h5>
                </div>
                <div className="w-50">
                  <span className="card-text">Last Name</span>
                  <h5 className="card-title">
                    {props.userProfile.profile.lastName}
                  </h5>
                </div>
              </div>
              <div className="mt-3">
                ...
                <h5 className="card-title">
                  {props.userProfile.profile.email}
                </h5>
              </div>
              <div className="mt-3">
                  ...
                  <div className="w-50">
                    ...
                    {props.userProfile.profile.address.streetAddress ? (
                      <h5 className="card-title">
                        ...
                        {props.userProfile.profile?.address?.state}
                      </h5>
                    ) : (
...
function mapState(state) {
  ...
  const { userProfile, profileDetailsUpdateRequired } =
