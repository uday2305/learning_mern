...
const ProductForm = (props) => {
  const [isTopProduct, setIsTopProduct] = useState(
    props.productDetails?.isTopProduct || false
  );
      ...
      <form className="mt-5" onSubmit={handleSubmit}>
        ...
        <div className="mb-3">
          ...
          <input
            ...
            name="category"
            id="Department"
            aria-describedby="department category"
          />
          {errors.category && (
        ...
        <div className="mb-3 form-check">
          <label htmlFor="isTopProduct" className="form-check-label">
            Top Selling Product
          </label>
          <input
            type="checkbox"
            ...
            aria-describedby="Top Selling Product"
          />
        </div>
