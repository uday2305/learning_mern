...
async function userProfile() {
    ...
    return fetch(`${config.API_URL}/profile`, requestOptions).then(handleResponse);
}
...
async function updateProfileAddress(address) {
    ...
    return fetch(`${config.API_URL}/profile/address`, requestOptions).then(handleResponse);
}
...
async function updateProfilePicture(imageSrc) {
    ...
    return fetch(`${config.API_URL}/profile/image`, requestOptions).then(handleResponse);
}
